(function (Scratch) {
    ...
    if (!Scratch.extensions.unsandboxed) {
        throw new Error("WebData 需在非沙盒中运行");
      }
    ...
    const apiKey = 'c0jtkzthm3e_FKh24Fhbi2Y3qdumF62G6PRHHze82FoL';
    var ProjectName = '';
    class WebData {
        constructor() { }
        getInfo() {
            return {
                ...
                blocks: [
                    ...
                    },
                    {
                        opcode: 'add',
                        blockType: Scratch.BlockType.COMMAND,
                        text: '将 [value] 命名为 [key_] 保存到云端数据库',
                        arguments: {
                            key_: {
                                type: Scratch.ArgumentType.STRING,
                                defaultValue: 'i'
